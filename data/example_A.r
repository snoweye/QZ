...
exA1 <- list(
  description = "https://support.nag.com/numeric/fl/nagdoc_fl22/xhtml/F08/f08pnf.xml",
...
exA2 <- list(
  description = "https://support.nag.com/numeric/fl/nagdoc_fl22/xhtml/F08/f08paf.xml",
...
exA3 <- list(
  description = "https://support.nag.com/numeric/fl/nagdoc_fl23/xhtml/F08/f08quf.xml",
...
exA4 <- list(
  description = "https://support.nag.com/numeric/fl/nagdoc_fl22/xhtml/F08/f08qgf.xml",
